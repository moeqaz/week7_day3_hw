console.log('this is promises.js');
...
//     .then(upper => console.log(`This is the song in all caps: ${upper}`));
//     .catch(err => console.warn(err));

// Real life example
// Get price of a users total based on their id
// userId -> user -> user's orders -> calculate their total
